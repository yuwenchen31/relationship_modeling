...
def generate_negative_samples(num_traj, span_size, negs, span_data):
    ...
    for index, i in enumerate(inds):
        ...
        # i is the entity pair id
        # span_data[i][2] -> go to i-th entity pair and to [2] - article with word id
        # len(span_data[i][2]) = how many articles for this entity pair
        # randomly pick a number between 0 and (# of articles for this pair)
        # e.g., pick a number between 0 and 14142
