...
# larn_data_path = cwd + "/short_data.pk"
# topic_emb_path = cwd + "/us-ru-10-topic-emb.pkl"
# model_save_path = cwd + "/outputs/test/"
...
# The following codes are adapted from: https://github.com/BoulderDS/LARN
...
# entity names 
entity_us_ru = ["U.S.", "US", "USA", "Trump", "Obama", "Russia", "Russian", "Putin"]
